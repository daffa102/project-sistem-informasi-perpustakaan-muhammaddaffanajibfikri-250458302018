        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                ...
                <div class="text-center mb-8">
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Buat Akun</h1>
                    <p class="text-gray-600">Bergabunglah dengan LibraryHub hari ini</p>
                </div>
               ...
               {{ $slot }}
                ...
                <p class="text-center text-gray-600 mt-8">
                    Sudah punya akun? <a href="{{route ('login')}}" class="text-purple-600 font-bold hover:text-purple-700">Masuk di sini</a>
                </p>
            </div>
            ...
            <div class="mt-8 bg-white/50 backdrop-blur rounded-2xl p-6 border border-white/50">
                <div class="space-y-3">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-sm text-gray-600">Akses unlimited ke 50K+ koleksi buku</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <span class="text-lg">✓</span>
                        <span class="text-sm text-gray-600">Rekomendasi personal berdasarkan preferensi</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <span class="text-lg">✓</span>
                        <span class="text-sm text-gray-600">Sinkronisasi di semua perangkat</span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
  ...
  toggleConfirm.addEventListener("click", () => {
    ...
    toggleConfirm.innerHTML = isPassword
      ? `<svg xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
            <path d="M17.94 17.94A10.94 10.94 0 0 1 12 19
                     c-7 0-11-7-11-7

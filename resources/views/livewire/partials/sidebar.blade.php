<div id="sidebar">
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            ...
            <div class="card shadow-sm p-3 mt-4" style="border-radius: 15px;">
                <div class="d-flex align-items-center gap-3">
                    <img src="{{ Auth::user()->profile_photo_url ?? asset('dist/assets/compiled/jpg/1.jpg') }}"
                        alt="Profile" class="rounded-circle" width="55" height="55" style="object-fit: cover;">
...
function initLogout() {
    ...
    if (logoutForm) {
        // Hapus listener lama jika ada (untuk menghindari duplikasi saat navigasi)
        ...
        newForm.addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (btn) {
                        btn.disabled = true;
                        btn.innerHTML = '<span class="spinner-border spinner-border-sm me-1"></span> Logging out...';
                    }
                    newForm.submit();
                }
            });
